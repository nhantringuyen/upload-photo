...
// Add all Drive scopes to the GoogleAuthProvider
...
/**
 * Initialize auth state listener. Call this once on app load.
 */
...
export const googleSignIn = async (): Promise<{ user: User; accessToken: string } | null> => {
  try {
    ...
    if (!credential?.accessToken) {
      throw new Error('Failed to obtain Google Drive OAuth access token from authorization response.');
    }
...
/**
 * Logout from Firebase Auth and clear token cache
 */
